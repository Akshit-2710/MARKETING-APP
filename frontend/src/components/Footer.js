...
export default function Footer() {
  ...
  return (
    <footer data-testid="footer" className="bg-[#1A3C8F] text-white py-20">
              ...
              {Object.entries(CONTACT.socialLinks).map(([key, url]) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-[#F8C8D4] hover:text-[#0D2561] transition-colors duration-200"
                  >
                    <SocialIcon size={16} />
                  </a>
                );
