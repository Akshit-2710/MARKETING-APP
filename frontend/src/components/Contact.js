          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div data-testid="contact-success" className="bg-white rounded-2xl p-12 text-center">
                <CheckCircle size={48} className="mx-auto text-[#1A3C8F] mb-4" />
                ...
                <button
                  ...
                  className="mt-6 text-sm font-semibold text-[#1A3C8F] underline"
                >
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <Input
                      ...
                      className="border-[#0D2561]/10 focus-visible:ring-[#1A3C8F] bg-[#FDE8EE]/30"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="border-[#0D2561]/10 focus-visible:ring-[#1A3C8F] bg-[#FDE8EE]/30 resize-none"
                  />
                </div>

                {error && (
                  <p data-testid="contact-error" className="text-red-500 text-sm">{error}</p>
                )}
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#1A3C8F] text-white font-semibold text-sm hover:bg-[#0D2561] transition-all duration-200 disabled:opacity-50"
                >
                  <Send size={16} />
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            <div className="bg-white rounded-2xl p-8 space-y-6">
              <div className="flex items-start gap-4" data-testid="contact-email-info">
                <div className="w-10 h-10 rounded-xl bg-[#F8C8D4] flex items-center justify-center text-[#1A3C8F] shrink-0">
                  <MailIcon size={18} />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4" data-testid="contact-address-info">
                <div className="w-10 h-10 rounded-xl bg-[#F8C8D4] flex items-center justify-center text-[#1A3C8F] shrink-0">
                  <MapPin size={18} />
                </div>
                <div>
                ...
                {Object.entries(CONTACT.socialLinks).map(([key, url]) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-[#F8C8D4] flex items-center justify-center text-[#1A3C8F] hover:bg-[#1A3C8F] hover:text-white transition-colors duration-200"
                    >
                      <SocialIcon size={18} />
                    </a>
                  );
